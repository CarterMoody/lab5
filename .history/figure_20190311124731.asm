...
line:
    ...
    add $t1, $zero, $zero
    add $t2, $zero, $zero
    add $t3, $zero, $zero                # add Zero into $temps, clearing it
    add $t4, $zero, $zero                # Might be more instructions than add rd, $zero, $zero
    add $t5, $zero, $zero
    add $t6, $zero, $zero
    add $t7, $zero, $zero
    add $t8, $zero, $zero
    ...
    add $t1, $t0, $zero     # Copy $t0 into $t1
    ...
    add $t4, $t3, $zero     # Copy $t3 into $t4
    ...
    add $t1, $t7, $zero                # Copy $t0 into $t1
    slt $t2, $t1, $zero            # Is $t1 less than 0?
    ...
    add $t3, $t1, $zero        # deltay = Math.abs(y1 - y0) from earlier
