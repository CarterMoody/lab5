...
main:
    ...
    ############################################
        ...
        # Display the result        
        li      $v0, 4			    # Load Immediate, '4', Specifying Text Output
        la 	$a0, str_swap1       # Place Contents of swap1 into $a0
        syscall                     # Execute Syscall
    ...
    # swap x0 and x1
        ...
        # Display the result        
        li      $v0, 4			    # Load Immediate, '4', Specifying Text Output
        la 	$a0, str_swap2       # Place Contents of swap1 into $a0
        syscall                     # Execute Syscall
...
############################################
        ...
        # Display the result        
        li      $v0, 1			    # Load Immediate, '1', Specifying Numerical Output
        add 	$a0, $t2, $0        # Place Contents of deltax into $a0
        syscall                     # Execute Syscall
...
## This IF needs debugging #############
    ...
    sll $s4, $t4, $t1       # $s4 = error * 2
        ...
        # Display the result        
        li      $v0, 1			    # Load Immediate, '1', Specifying Numerical Output
        add 	$a0, $t4, $0        # Place Contents of error into $a0
        syscall                     # Execute Syscall
